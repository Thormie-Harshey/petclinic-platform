...
echo ""
echo "Next steps:"
echo "1. Copy backend.hcl.example to backend.hcl in each environment and fill in your account ID"
echo "2. Initialize Terraform in each environment:"
echo "   cd terraform/environments/dev && terraform init -backend-config=backend.hcl"
echo "   cd terraform/environments/prod && terraform init -backend-config=backend.hcl"
echo ""
